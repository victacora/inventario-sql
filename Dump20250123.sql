...
INSERT INTO `tbl_departamento` VALUES (1,'001','Cauca',1),(2,'002','Cundinamarca',1),(3,'003','Antioquia',1),(4,'001','Washington',2);
...
BEGIN
  SELECT usu.usu_id,usu.usu_usuario as usuario, per.pers_nombre_razonsocial as nombres, per.pers_apellido as apellidos, per.pers_correo_electronico as correo, usu.tbl_rol_rol_id, rol.rol_nombre  FROM tbl_usuario as usu 
...
-- Dump completed on 2025-01-23  8:48:09
